  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          [sty.rootpicture_bottom]: hasVariant(variants, "picture", "bottom"),
          [sty.rootpicture_left]: hasVariant(variants, "picture", "left"),
          [sty.rootpicture_right]: hasVariant(variants, "picture", "right"),
          [sty.rootpicture_top]: hasVariant(variants, "picture", "top")
        }
      )}
    >
      {true ? (
        <p.Stack
          ...
          className={classNames(projectcss.all, sty.wrapper, {
            ...
            [sty.wrapperpicture_left]: hasVariant(variants, "picture", "left"),
            [sty.wrapperpicture_right]: hasVariant(
              variants,
              "picture",
              "right"
            ),
            [sty.wrapperpicture_top]: hasVariant(variants, "picture", "top")
          })}
        >
          {(
            hasVariant(variants, "picture", "right")
              ? true
              : hasVariant(variants, "picture", "left")
              ? true
              : hasVariant(variants, "picture", "bottom")
              ? true
              : hasVariant(variants, "picture", "top")
              ? true
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicBlockPicture__ArgsType, ReservedPropsType> &
